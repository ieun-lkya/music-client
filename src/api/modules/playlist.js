...
export const renamePlaylistAPI = (playlistId, name) => http.post('/playlist/rename', null, { params: { playlistId, name } })
export const removeMusicFromPlaylistAPI = (playlistId, musicId) => http.delete('/playlist/removeMusic', { playlistId, musicId })
